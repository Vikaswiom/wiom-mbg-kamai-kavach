...
seg AS (
  SELECT m.cspid,
    CASE WHEN c.cspid IS NOT NULL THEN 'A_clicked' ELSE 'B_noclick' END AS segment
  FROM mbg m LEFT JOIN clicks c ON c.cspid = m.cspid
  UNION ALL
